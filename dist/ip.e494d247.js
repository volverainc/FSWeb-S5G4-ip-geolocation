...
var url = _axios.default.get("https://apis.ergineer.com/ipadresim");
url.then(function (resolve) {
  console.log(resolve.data);
  var getIP = _axios.default.get("https://apis.ergineer.com/ipgeoapi/" + resolve.data);
  getIP.then(function (res) {
    console.log(res.data);
    ipContainer(res.data);
  });
});
var ipContainer = function ipContainer(card) {
  var cards = document.querySelector(".cards");
  var cart = document.createElement("div");
  cart.classList.add("card");
  cards.append(cart);
  var bayrakImg = document.createElement("img");
  bayrakImg.setAttribute("src", "".concat(card.ülkebayrağı));
  ...
  title.textContent = "".concat(card.sorgu);
